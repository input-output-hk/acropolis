        ...
        match self {
            ...
            Address::Shelley(shelley) => {
                ...
                let (delegation_hash, delegation_bits): (&Vec<u8>, u8) = match &shelley.delegation {
                    ...
                    ShelleyAddressDelegationPart::Pointer(_pointer) =>
                        return Err(anyhow!("Pointer addresses not implemented"))
                        // TODO variable-length encoding of pointer.*
                        // delegation_bits = 2
                };

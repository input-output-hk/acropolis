...
/// Metadata structure for Conway snapshots as stored in manifest JSON files.
///
/// The manifest file accompanies the binary snapshot CBOR file and provides
/// containing metadata for validation and integrity checking.

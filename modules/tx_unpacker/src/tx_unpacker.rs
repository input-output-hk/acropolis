...
impl TxUnpacker {
    ...
    fn map_nullable_result<Src: Clone, Dst>(
    ...
    fn map_protocol_param_update(p: &conway::ProtocolParamUpdate) -> Box<ProtocolParamUpdate> {
        Box::new(ProtocolParamUpdate {
            ...
            pool_voting_thresholds: p
                ...
                .as_ref()
                .map(&Self::map_pool_voting_thresholds),
            drep_voting_thresholds: p
                .drep_voting_thresholds
                .as_ref()
                .map(&Self::map_drep_voting_thresholds),
    ...
    fn map_governance_action(action: &conway::GovAction) -> Result<GovernanceAction> {
        match action {
            ...
            conway::GovAction::NoConfidence(id) => Ok(GovernanceAction::NoConfidence(
                Self::map_nullable_gov_action_id(id)?,
            )),
    ...
    fn map_governance_proposals_procedures(
    ...
    fn map_all_governance_voting_procedures(

...
use handlers::{
    ...
    assets::{
        ...
        handle_policy_assets_asset_single_blockfrost,
    },
    epochs::{
...
const DEFAULT_HANDLE_POLICY_ASSETS_ASSET_SINGLE_TOPIC: (&str, &str) = (
...
impl BlockfrostREST {
    pub async fn init(&self, context: Arc<Context<Message>>, config: Arc<Config>) -> Result<()> {
        ...
        // Handler for /assets/{asset} and /assets/policy/{policy_id}
        register_handler(
            context.clone(),
            DEFAULT_HANDLE_POLICY_ASSETS_ASSET_SINGLE_TOPIC,
            handlers_config.clone(),
            handle_policy_assets_asset_single_blockfrost,
        );
